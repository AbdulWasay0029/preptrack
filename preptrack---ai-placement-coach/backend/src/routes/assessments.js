...
router.post('/:id/respond', async (req, res) => {
  ...
  const { question_id, user_response, time_taken_seconds, score, feedback } = req.body;

  try {
    await db.query(`
      INSERT INTO assessment_responses (assessment_id, question_id, user_response, ai_score, ai_feedback, time_taken_seconds)
      VALUES ($1, $2, $3, $4, $5, $6)
    `, [assessmentId, question_id, user_response, score || 0, feedback || 'No feedback', time_taken_seconds || 0]);
